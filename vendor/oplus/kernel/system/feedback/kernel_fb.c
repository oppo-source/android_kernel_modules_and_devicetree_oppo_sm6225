...
#define FB_EVENT_ID_LEN (15)
#define FB_REASON_LEN (256)
#define FB_PAGE_SIZE (512)

typedef struct bsp_fb_work_struct {
	struct delayed_work dwork;
	spinlock_t lock;
	int tag_id;
	char event_id[FB_EVENT_ID_LEN];
	char reason[FB_REASON_LEN];
} bsp_fb_work_struct;
