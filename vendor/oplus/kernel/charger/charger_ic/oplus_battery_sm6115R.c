...
extern void notify_pd_event(struct sy697x *g_sy, struct oplus_chg_chip *chg_chip, unsigned long evt);
extern void splitchg_request_dpdm(struct sy697x *g_sy, bool enable);
