...
int __maybe_unused ilitek7807s_spi_probe(struct spi_device *spi)
{
	...
	//ILI_INFO("%s gpio_direction_output = %d\n", __func__, gpio_direction_output(112, 1));
	//msleep(5);
	//ILI_INFO("%s gpio_direction_input = %d\n", __func__, gpio_direction_input(112));
	//ILI_INFO("%s gpio_to_irq = %d\n", __func__, gpio_to_irq(112));
