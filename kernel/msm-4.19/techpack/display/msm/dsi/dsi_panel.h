...
struct dsi_panel_oplus_privite {
	...
	bool display_off_set_pixel_off;
...
#define PANEL_POWER_SEQ_MAX	(0xF)
typedef struct power_operation_delay {
	u32 on_behind_mdelay;
	u32 off_behind_mdelay;
	u32 gesture_on_behind_mdelay;
	u32 gesture_off_behind_mdelay;
}POWER_OPER_DELAY;

struct oplus_panel_power_parse {
	bool oplus_panel_power_ctl;
	u8 panel_on_power_seq[PANEL_POWER_SEQ_MAX];
	u8 panel_on_power_seq_num;
	u8 panel_off_power_seq[PANEL_POWER_SEQ_MAX];
	u8 panel_off_power_seq_num;
	u8 panel_shutdown_power_seq[PANEL_POWER_SEQ_MAX];
	u8 panel_shutdown_power_seq_num;
	u8 panel_gesture_on_power_seq[PANEL_POWER_SEQ_MAX];
	u8 panel_gesture_on_power_seq_num;
	u8 panel_gesture_off_power_seq[PANEL_POWER_SEQ_MAX];
	u8 panel_gesture_off_power_seq_num;
	u8 panel_gesture_shutdown_power_seq[PANEL_POWER_SEQ_MAX];
	u8 panel_gesture_shutdown_power_seq_num;
	bool config_set_end_flag;
	bool panel_vci_enable_flag;
	bool panel_vddio_enable_flag;
	bool panel_reset_enable_flag;
	bool panel_bias_enable_flag;
	bool panel_regulator_enable_flag;
	bool panel_pinctrl_state_enable_flag;
	bool tp_load_fw_succ_flag;
	bool panel_shutdown_power_set_flag;
	POWER_OPER_DELAY vci_mdelay;
	POWER_OPER_DELAY vddio_mdelay;
	POWER_OPER_DELAY bias_mdelay;
	POWER_OPER_DELAY reset_mdelay;
	POWER_OPER_DELAY pinctrl_mdelay;
	POWER_OPER_DELAY regulator_mdelay;
	u32 panel_on_lp11_not_enable_mdelay;
	u32 panel_on_tp_load_fw_behind_mdelay;
	u32 panel_gesture_on_tp_load_fw_behind_mdelay;
};
#endif /* OPLUS_BUG_STABILITY */
...
struct dsi_panel {
	...
	struct oplus_panel_power_parse oplus_panel_power;
